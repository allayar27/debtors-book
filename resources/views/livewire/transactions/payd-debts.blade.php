    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-3">
          <ol class="breadcrumb float-sm-right">
            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#createModal" wire:click="addNew"><i class="fa fa-plus-circle mr-1"></i>Добавить</button>
          </ol>
        </div>
      </div>
